...
xhr_url = 'https://www.instagram.com/graphql/query/?query_hash=a5164aed103f24b03e7b7747a2d94e3c&variables=%7B%22id%22%3A%22{user_id}%22%2C%22first%22%3A12%2C%22after%22%3A%22{cursor}%22%7D'
# 构造XHR请求
# https://www.instagram.com/graphql/query/?query_hash=a5164aed103f24b03e7b7747a2d94e3c&variables={"id":"{user_id}","first":12,"after":"{cursor}"}
...
def get_parser():
    parser = argparse.ArgumentParser(
        description='Crawls photos and videos of Instagram bloggers.')
    parser.add_argument('user', metavar='username', type=str,
                        nargs=1, help='the user name of instagram')
    return parser
...
def get_urls(html):
    ...
    while flag:
        urls = []
        url = xhr_url.format(user_id=user_id, cursor=cursor)
    ...
    for urls in get_urls(html):
        try:
            ...
            for i, content in enumerate(contents):
                ...
                file_path = r'.\{0}\{1}.{2}'.format(
                    user, md5(content).hexdigest(), endw)
